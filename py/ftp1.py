...
def main():
    ...
    try:
        ...
        download_file(f, './' + iphone_fileName, IPHONE_DIR + iphone_fileName)
        download_file(f, './' + android_fileName, ANDROID_DIR + android_fileName)
